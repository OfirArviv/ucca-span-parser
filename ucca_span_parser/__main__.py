...
from allennlp.data.token_indexers import PosTagIndexer, PretrainedBertIndexer, DepLabelIndexer, \
    NerTagIndexer, SingleIdTokenIndexer
from torch import optim


from ucca_span_parser.htl_suda_ucca_parser.module.span_parser import Topdown_Span_Parser_Factory
from ucca_span_parser.htl_suda_ucca_parser.module.remote_parser import Basic_Remote_Parser_Factory
from ucca_span_parser.models.ucca_span_parser import UccaSpanParser
from ucca_span_parser.metrics.ucca_scores import UccaScores
from ucca_span_parser.tokenizers.word_splitter import SpacyMultilingualWhitespaceWordSplitter
from ucca_span_parser.dataset_readers.ucca_dataset_reader import UccaSpanParserDatasetReader
from ucca_span_parser.factories.allennlp_builtin import BidirectionalEndpointSpanExtractorFactory, LstmEncoderFactory, \
    Seq2VecEncoderFactory
from ucca_span_parser.token_indexers.language_indexer import LanguageIndexer
...
if __name__ == '__main__':
    ...
    encoder: Seq2VecEncoderFactory = LstmEncoderFactory(encoder_output_dim, 2, dropout=0.4, bidirectional=True)

    # span_extractor: SpanExtractor = SelfAttentiveSpanExtractor(input_dim=encoder.get_output_dim())
    span_extractor: SpanExtractor = BidirectionalEndpointSpanExtractorFactory()
